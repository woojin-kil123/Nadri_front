          ...
          <nav className="join-agree-table">
            <ul>
                ...
                >
                  <div className="agree-content">
                    ...
                    >
                      ...
                      <p>
                        ⑤ 서비스수수료란 "이용자"가 "홈&빌라" 서비스를 이용할 때
                        "플랫폼"에 지급하는 수수료를 말합니다.
                      </p>
                      <p>
                      ...
                      <p>
                        ① "회사"는 이 약관의 내용과 상호 및 대표자 성명, 영업소
                        소재지 주소(소비자의 불만을 처리할 수 있는 곳의 주소를
                        포함), 전화번호, E-mail주소, 사업자등록번호, 통신판매업
                        신고번호, 개인정보보호책임자등을 "이용자"가 쉽게 알 수
                        있도록 "플랫폼"의 초기 서비스화면(전면)에 게시합니다.
                        다만, 약관의 내용은 "이용자"가 연결화면을 통하여 볼 수
                        있도록 할 수 있습니다.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        "이용자"에게 불리하게 약관내용을 변경하는 경우에는
                        최소한 30일 이상의 사전 유예기간을 두고 공지합니다. 이
                        경우 "회사"는 개정 전 내용과 개정 후 내용을 "이용자"가
                        알기 쉽도록 표시합니다.
                      </p>
                      <p>
                      ...
                      <p>
                        ⑤ "회원"이 전④항에 따라 약관에 대한 반대의사를 표시하지
                        않고 "서비스"를 이용한 경우에는 약관에 동의한 것으로
                        봅니다.
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        경우 2. 등록 내용에 타인의 정보를 사용한 경우 3. 만 14세
                        미만의 아동이 신청하는 경우
                      </p>
                      <p>
                      ...
                      <p>
                        ...
                        상당한 기간 이내에 "플랫폼"에 대하여 회원정보 수정하거나
                        E-mail 등의 방법으로 그 변경사항을 알려야 합니다.
                      </p>
                      <p>
              ...
              <li>
                ...
                />
                <label htmlFor="check3">(필수) 이용약관</label>
                <ChevronRightIcon
                  className="join-chevron-icon"
                  onClick={handleToggle}
                  style={{
              ...
              <li>
                ...
                />
                <label htmlFor="check4">(필수) 이용약관</label>
                <ChevronRightIcon
                  className="join-chevron-icon"
                  onClick={handleToggle}
                  style={{
              ...
              <li>
                ...
                />
                <label htmlFor="check5">(필수) 이용약관</label>
                <ChevronRightIcon
                  className="join-chevron-icon"
                  onClick={handleToggle}
                  style={{
              ...
              <li>
                ...
                />
                <label htmlFor="check7">(필수) 이용약관</label>
                <ChevronRightIcon
                  className="join-chevron-icon"
                  onClick={handleToggle}
                  style={{
              ...
              <li>
                ...
                <ChevronRightIcon className="join-chevron-icon" />
              </li>
              <li>
                <input
                  type="checkbox"
